...
- **Akku:** **2S-Pack (6,0–8,4 V), 3-polig (B− / Mittelabgriff / B+)** — **Zellschutz und Balancing liegen seit 16.09.2026 auf unserer Platine** (`U_PROT` HY2120-CB mit Schalterpaar Q_PROT1/Q_PROT2: Überladung 4,28 V/Zelle, Tiefentladung 2,90 V/Zelle, Überstrom ≈ 17 A; Balancing im IP2326 über R_CB am Mittelabgriff). Ein BMS im Pack ist damit **nicht** mehr nötig (Nutzerentscheidung 16.09.2026: „alles auf die Platine … kein zweites extra Bord"); Details in `hardware/schaltplan_v1.md` §6.3; Laden über den **IP2326** (2S-Boost-Lader aus 5 V USB, 8,4 V / 0,90 A) auf unserer Platine (USB-C-Durchbruch in der Wulst). Aus dem Pack entstehen **+5 V (SY8113B-Buck, 3 A)** für beide Pumpen und **+3,3 V (AP63203-Buck, 2 A)** für die Logik — **kein LDO, kein Boost**.
