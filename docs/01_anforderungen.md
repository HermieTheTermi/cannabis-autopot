...
- **Akku:** **2S-Pack (6,0–8,4 V) mit Zellschutz-PCM/BMS — Pflicht**; Balancing ist die zweite Ebene (schützt Kapazität und Lebensdauer, nicht die Sicherheit — die übernimmt der PCM pro Zelle): drei Wege in `hardware/schaltplan_v1.md` §6.3; Laden über den **IP2326** (2S-Boost-Lader aus 5 V USB, 8,4 V / 0,90 A) auf unserer Platine (USB-C-Durchbruch in der Wulst). Aus dem Pack entstehen **+5 V (SY8113B-Buck, 3 A)** für beide Pumpen und **+3,3 V (AP63203-Buck, 2 A)** für die Logik — **kein LDO, kein Boost**.
