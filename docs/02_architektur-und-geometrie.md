...
**Pumpenposition:** Pumpe in der Wulst (oberhalb des Wassers), **Saugschlauch** durch den Kanal bis auf den Tankboden (y ≈ 8 mm, Ansaugkorb/Gewicht), **Druckschlauch** nach oben zum Verteilerring. Peristaltik ist selbstansaugend (Eigenschaft der Bauart; für diese Pumpe nicht ausdrücklich zugesichert → im Aufbau prüfen) → Position unkritisch. **Förderhöhe nachgerechnet (14.09.2026):** 200 mm Hub = 0,0196 bar gegen typ. 0,5–1 bar Pumpendruck → **20–40× Reserve**, Saughöhe 106 mm gegen „Ansaugbereich 0,5 m" = 4,7× Reserve. **Betrieb ohne Wandler direkt an der 1S-Zelle** — ⚠️ die aktuelle Pumpe (CONQUERALL DC 5 V) ist aber mit **5 V Nennspannung** spezifiziert, liegt also im 1S-Betrieb unterhalb ihrer Nennspannung; Betrieb und Anlaufstrom sind **nicht belegt** und müssen gemessen werden, und der **PWM-Softstart ist Pflicht** (siehe `../hardware/bom_entscheidung.md` §3/§3b/§4c).
