...
| Inhalt | ESP32-C6-MINI-1 (13,2 × 16,6 mm) + Lader/LDO/USB auf eigener PCB (Zielgröße ≤ 38 mm breit) + 2 Lötpads für den externen Taster, LiPo-Zelle 59 × 37 × 5 mm, **Pumpe CONQUERALL 5 V (Bauhöhe 42 mm, Ø nicht dokumentiert — Wulst ist auf Ø 32 gerechnet)**, Taster, LED |
...
**Pumpenposition:** Pumpe in der Wulst (oberhalb des Wassers), **Saugschlauch** durch den Kanal bis auf den Tankboden (y ≈ 8 mm, Ansaugkorb/Gewicht), **Druckschlauch** nach oben zum Verteilerring. Peristaltik ist selbstansaugend (Eigenschaft der Bauart; für diese Pumpe nicht ausdrücklich zugesichert → im Aufbau prüfen) → Position unkritisch. **Förderhöhe nachgerechnet (14.09.2026):** 200 mm Hub = 0,0196 bar gegen typ. 0,5–1 bar Pumpendruck → **20–40× Reserve**, Saughöhe 106 mm gegen „Ansaugbereich 0,5 m" = 4,7× Reserve. **Betrieb jetzt am 5-V-Boost** — ⚠️ **geändert 15.09.2026:** Bis dahin hing die Pumpe direkt an der 1S-Zelle, im Betrieb unterhalb ihrer Nennspannung (Messauftrag). Auf Wunsch bekommen jetzt **beide** Pumpen (Dosier- **und** Sauerstoffpumpe) **5 V**: **U8 MT3608** erzeugt eine geregelte **+5-V-Schiene (5,10 V)** aus VBAT, jede Pumpe hängt über einen eigenen AO3400A (Q1/Q3) daran (`hardware/schaltplan_v1.md` §10). Der **PWM-Softstart bleibt Pflicht** — jetzt nicht wegen der Zellspannung, sondern weil der Boost den Anlaufstrom nicht liefern kann. **Die Sauerstoffpumpe darf nicht dauerhaft laufen** (Zelle in ~2,5 h leer) und gehört **außerhalb des Gehäuses** (frische Luft).
