...
NETS = {
    ...
    # Erweiterung 14.09.2026: geschaltete Versorgung 0,5 mm, Signale 0,25 mm
    "VCC_EXT":    ("power-branch", W_HIGH,   0.25, 0.10,  "TOP", "Q2 Drain -> J8/J9-J15 (geschaltete Erweiterungsversorgung)"),
    "EXT_EN":     ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO20 -> Q2 Gate"),
    "SDA":        ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "I2C SDA, Steckerseite J8-3 (R_SDA_S + R_SDA_PU)"),
    "SDA_MCU":    ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "I2C SDA am Modul, IO18 (R_SDA_S)"),
    "SCL":        ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "I2C SCL, Steckerseite J8-4 (R_SCL_S + R_SCL_PU)"),
    "SCL_MCU":    ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "I2C SCL am Modul, IO19 (R_SCL_S)"),
    "SPARE_AIN_RAW": ("signal",    W_SIGNAL, 0.15, 0.001, "TOP", "Reserve-Analog J9-3 (R_SPARE_AIN)"),
    "SPARE_AIN":  ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "ADC1_CH5 (IO5), R_SPARE_AIN + C_SPARE"),
    "SPARE_IO15_RAW": ("signal",   W_SIGNAL, 0.15, 0.001, "TOP", "Reserve IO15 J10-3 (R_SPARE_IO15)"),
    "SPARE_IO15": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO15 am Modul (R_SPARE_IO15)"),
    "SPARE_IO16": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO16/TXD0 -> J11-3 (R_SPARE_IO16)"),
    "SPARE_IO17": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO17/RXD0 -> J12-3 (R_SPARE_IO17)"),
    "SPARE_IO21_RAW": ("signal",   W_SIGNAL, 0.15, 0.001, "TOP", "Reserve IO21 J13-3 (R_SPARE_IO21)"),
    "SPARE_IO21": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO21 am Modul (R_SPARE_IO21)"),
    "SPARE_IO22_RAW": ("signal",   W_SIGNAL, 0.15, 0.001, "TOP", "Reserve IO22 J14-3 (R_SPARE_IO22)"),
    "SPARE_IO22": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO22 am Modul (R_SPARE_IO22)"),
    "SPARE_IO23_RAW": ("signal",   W_SIGNAL, 0.15, 0.001, "TOP", "Reserve IO23 J15-3 (R_SPARE_IO23)"),
    "SPARE_IO23": ("signal",       W_SIGNAL, 0.15, 0.001, "TOP", "IO23 am Modul (R_SPARE_IO23)"),
