...
| 4 | **Akku (2S)** ⭐ | **Keeppower 2S1P 2×18500 2000 mAh** (18,5 × 103 mm, 70 g, ~14,8 Wh); Alternative **2×18650 3400 mAh** (18,7 × 134 mm, 100 g, ~25 Wh) | **10,90 €** / **14,90 €** | akkuteile.de (beide auf Lager, 16.09.2026) | ✅ Preise + Lager live geprüft (`../research/bom-check/10_2s-akku-quellen.md`). Schutzplatine (Seiko) dokumentiert, **Balancing nicht** → drei Wege in `hardware/schaltplan_v1.md` §6.3. Betrieb 6,0–8,4 V, Wächter-Abschaltung bei 6,16 V |
